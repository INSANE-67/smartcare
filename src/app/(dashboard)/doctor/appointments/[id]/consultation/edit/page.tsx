...
export const metadata: Metadata = {
  title: "Edit Consultation Note — SmartCare",
  description: "Edit the consultation note for this appointment.",
};

export default async function EditConsultationNotePage({
  params,
}: {
  ...
  return (
    <div className="dash-content max-w-4xl">
      <div className="dash-page-header">
        <div>
          <h1 className="dash-page-title">Edit Consultation Note</h1>
          <p className="dash-page-subtitle">
            {patientName} • {new Date(appointment.appointment_date).toLocaleDateString()}
          </p>
        </div>
        <div className="dash-page-actions">
          <Link href={`/doctor/appointments/${appointmentId}/consultation`} className="dash-btn dash-btn-secondary">
            &larr; Back to Note
          </Link>
        </div>
      </div>
